...
last_commit: docs: session-end checkpoint after v0.1.0 ship  # cebe2ec (T-099 commit pending in this turn)
...
blockers: none.
working_tree:
  pre_commit_modified: [Cargo.lock, crates/obsbot-gui/Cargo.toml, crates/obsbot-gui/src/application.rs, crates/obsbot-gui/src/controls_view.rs, crates/obsbot-gui/src/window.rs, docs/PLAN.md, docs/PROGRESS.md, docs/ROADMAP.md, docs/STATE.md]
  pre_commit_untracked: [crates/obsbot-gui/build.rs, crates/obsbot-gui/resources/]
  pre_commit_deleted: []
...
updated_at: 2026-05-13T21:20:00Z  # T-099 closed
